...
/**
		*A háromszögek adatainak a VBO-nak megfelelõ strutúrába konvertálása
*/
std::vector<VboVertex> convert_triangles_to_vbo(const Model& model);

/**
		*A négyszögek adatainak a VBO-nak megfelelõ strutúrába konvertálása
*/
