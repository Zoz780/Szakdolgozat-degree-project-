...
std::vector<Triangles> HeightMap3D::specify_the_triangles()
{
	...
	for (int i = 0; i < m_vbo_indices.size() / 3; i++)
	{
		one_triangle.points[0].x = m_vbo_vertex_maps[m_vbo_indices[index]-1].x;
		one_triangle.points[0].y = m_vbo_vertex_maps[m_vbo_indices[index]-1].y;
		one_triangle.points[0].z = m_vbo_vertex_maps[m_vbo_indices[index]-1].z;
		index++;

		one_triangle.points[1].x = m_vbo_vertex_maps[m_vbo_indices[index]-1].x;
		one_triangle.points[1].y = m_vbo_vertex_maps[m_vbo_indices[index]-1].y;
		one_triangle.points[1].z = m_vbo_vertex_maps[m_vbo_indices[index]-1].z;
		index++;

		one_triangle.points[2].x = m_vbo_vertex_maps[m_vbo_indices[index]-1].x;
		one_triangle.points[2].y = m_vbo_vertex_maps[m_vbo_indices[index]-1].y;
		one_triangle.points[2].z = m_vbo_vertex_maps[m_vbo_indices[index]-1].z;
		index++;
    ...
    //cout << "Number of triangles: " << index/3 << endl;
	return triangles;
}
...
{
	double delta;
	double h, hx, hy, delta_x, delta_y;
