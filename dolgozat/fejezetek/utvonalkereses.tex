...
\begin{algorithm}[H]
 ...
 \For {Waypoint pont : waypointokon}{
 	x := pont.x;\\
	y := pont.y;\\
	x\_tav := abs(x – jelenlegi\_xpoz);\\
	y\_tav := abs(y – jelenlegi\_ypoz);\\
...
% TODO: Képet nagyítani, nekem valamiért szétcsúszik a szöveg!
