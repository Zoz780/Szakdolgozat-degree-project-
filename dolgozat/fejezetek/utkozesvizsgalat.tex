...
\subsection{Program: Collision Detection Demo}
...
\subsection{Program: Quadtree Demo}

% TODO: Ezt itt korrigálni kellene, mert a szélesség és magasság megadására nincs szükség. Elegendő csak felváltva tárolni az $x$ és $y$ szerinti felosztáshoz használt értékeket.


Megvalósítás során meg kell adnunk a gyökér csomópontot, ami a teljes, felosztani kívánt területet takarja. Egy csomópont a következő adattagokat tartalmazza:
\begin{itemize}
\item $x$ és $y$ pozíció
