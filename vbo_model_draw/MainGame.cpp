...
void MainGame::Init()
{
	...
	m_window = SDL_CreateWindow("VBO Demo", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, m_screen_width, m_screen_hight, SDL_WINDOW_OPENGL);
	...
	raptor.Load("Models/raptor.obj", 0.4f, 0.4f, 0.4f, "Textures/raptor.png");
}
...
void MainGame::DrawGame()
{
	...
	raptor_rotation += 0.2f;

	glPushMatrix();
	glTranslatef(0, 80, -20);
	glRotatef(90.0f, 1, 0, 0);
	glRotatef(raptor_rotation, 0, 1, 0);
	raptor.DrawModel(0, 0, 0);
	glPopMatrix();
